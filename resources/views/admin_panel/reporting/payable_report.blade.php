...
@section('content')
<style>
    .payable-table { width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; }
    .payable-table th, .payable-table td { padding: 12px; border: 1px solid #eee; text-align: right; }
    .payable-table th { background-color: #f8f9fa; font-weight: bold; text-align: center; text-transform: uppercase; font-size: 0.9rem; }
    .payable-table .text-left { text-align: left; }
    .payable-table .text-center { text-align: center; }
    ...
    @media print {
        ...
        .payable-table th, .payable-table td { border: 1px solid #ccc !important; }
    }
</style>
                    ...
                    <table class="payable-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 25%;" class="text-left">PARTY (VENDOR)</th>
                                <th style="width: 15%;">OPENING</th>
                                <th style="width: 15%;">PURCHASES</th>
                                <th style="width: 20%;">CASH PAID</th>
